...
public class MailSender {
	...
	public void sendingMail(String recipient, String flag, LtmContentPlan content) throws AddressException, MessagingException {
		...
		String subject = content.getLtmhSubject();
		if (flag.equals("10")) {
		...
		String contentTemp = content.getLtmhContent();
