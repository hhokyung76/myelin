package com.ltmh.app.http.service;
...
import com.ltmh.app.server.hive.HiveDbConfig;
import com.ltmh.app.server.presto.PrestoDbConfig;
import com.ltmh.core.config.DatabaseHiveConfig;
import com.ltmh.dao.h2.DbH2Mapper;
import com.ltmh.dao.hive.DbHiveMapper;
import com.ltmh.dao.presto.DbPrestoMapper;
import com.ltmh.framework.mail.MailSender;
import com.ltmh.framework.util.OpenStringUtils;
import com.ltmh.server.dto.LtmhContent;
import com.ltmh.server.main.Customer;
...
//							+", p_month="+partionInfo.get("pYear")+", p_day="+partionInfo.get("pYear")+", p_hour="+partionInfo.get("pYear") + ", p_minute="+partionInfo.get("pYear")+")");
	...
	public void addLtmhContentPlan(LtmhContent content) {
		LtmContentPlan planContent = new LtmContentPlan();
		planContent.setCustEmail(content.getCustEmail());
		planContent.setCustId(content.getCustId());
		planContent.setLtmhContent(content.getLtmhContent());
		planContent.setLtmhSubject(content.getLtmhSubject());
		planContent.setLtmhFlag("00");
