...
import com.ltmh.framework.mail.MailSessionManager;
...
//	            }
				...
				LtmContentPlan planObj = new LtmContentPlan();
				planObj.setCustEmail(email);
				planObj.setLtmhFlag("10");
				planObj.setCustId(email);
				planObj.setLtmhContent(realContent);
				planObj.setLtmhSubject(message.getSubject());
